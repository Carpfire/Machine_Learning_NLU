...
def encode_data(dataset, tokenizer, max_seq_length=128):
  ...
  """
    ...
    tokenized_examples = tokenizer(list(dataset["question"]), list(dataset["passage"]),
    ...
    return torch.LongTensor(tokenized_examples['input_ids']), torch.LongTensor(tokenized_examples['attention_mask'])
